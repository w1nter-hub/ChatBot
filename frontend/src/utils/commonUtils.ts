...
export const chatWidgetDefaultValues = {
  ...
  emailFieldLabel: "Электрондық пошта",
  emailFieldPlaceholder: "Пошта мекенжайыңызды енгізіңіз",
  msgFieldLabel: "Хабарлама",
  msgFieldPlaceholder: "Хабарламаңызды жазыңыз",
  requiredFieldMsg: "Бұл өрісті толтыру қажет",
  invalidEmailMsg: "Дұрыс электрондық пошта енгізіңіз",
  formSubmitBtnLabel: "Жіберу",
  formSubmitBtnSubmittingText: "Жіберілуде...",
  formSubmitSuccessMsg: "Хабарламаңыз сәтті жіберілді!",
  formSubmitErrorMsg: "Қате орын алды, әрекетті қайталаңыз",
  formSendAgainBtnLabel: "Қайта жіберу",
