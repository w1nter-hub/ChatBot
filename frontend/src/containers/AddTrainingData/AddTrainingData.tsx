...
export const AddTrainingData = ({
	...
	return (
		<Box>
			<Box>
				<Button leftIcon={<FiPlus />} onClick={onOpen} colorScheme='blue'>Дерек қосу</Button>
			</Box>
			<Modal
					...
					<ModalBody pb={6}>
						...
						<FormControl mt={6}>
							...
							<FormHelperText fontSize="smaller" color="gray.400">
								...
								## What is QoldauAI?
								<br />
								#### QoldauAI allows you to train ChatGPT on your website data and build a chatbot that you can add to your website. 				
								<br />
